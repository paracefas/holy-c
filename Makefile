...
CXXFLAGS = -Wall -Wextra -I. -O3 -std=c++26 -I "C:\Users\Teologado-6\Documents\Fr. Emanuel\dev\cpp\fmt\include" -lstdc++exp -fno-diagnostics-show-option -fmax-errors=1

# Lista de archivos fuente (.cpp)
# Añadimos todos los que has creado
SRCS = main.cpp ast.cpp parser.cpp
